...
/**
 * This class loads the Friends Request list of the user
 */
@SuppressLint("StaticFieldLeak")
public class FriendsRequestListFragment extends Fragment {
    ...
    private static void queryUser(CloudDBZoneQuery<Users> query) {
        ...
        queryTask.addOnSuccessListener(FriendsRequestListFragment::processQueryResult).addOnFailureListener(e -> {
            dismissDialog();
            swipeContainer.setRefreshing(false);
        });
    }
    ...
    private static void processQueryResult(CloudDBZoneSnapshot<Users> snapshot) {
        ...
        try {
            while (userInfoCursor.hasNext()) {
                ...
                String mFriendList = mUsers.getFriendRequestList();
                if (mFriendList != null) {
    ...
    private static void queryAllUser() {
        ...
        queryTask.addOnSuccessListener(snapshot -> {
            ...
            FriendsRequestListAdapter mItemAdapter = new FriendsRequestListAdapter(mContext, mActivity, mUserModelArraylist, mCloudDBZone);
