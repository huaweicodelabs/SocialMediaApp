...
package com.huawei.hms.socialappsharing.videoplayer;
...
import com.huawei.hms.socialappsharing.videoplayer.control.PlayControl;
...
import com.huawei.hms.socialappsharing.videoplayer.utils.SelectDialog;
import com.huawei.hms.socialappsharing.videoplayer.utils.StringUtil;
import com.huawei.hms.socialappsharing.videoplayer.view.PlayView;
    ...
    public void onSettingItemClick(String itemSelect, int settingType) {
        switch (settingType) {
            ...
            case Constants.PLAYER_SWITCH_AUTO_DESIGNATED:
                switchBitrateMenu(TextUtils.equals(itemSelect,
            ...
            case Constants.PLAYER_SET_WAKE_MODE:
                playControl.setWakeMode(TextUtils.equals(itemSelect,
                        StringUtil.getStringFromResId(PlayActivity.this, R.string.set_wake_mode)));
                break;
            default:
                break;
